    ...
    <?php include 'header.inc'; ?>
      ...
      <div id="banner" class="col12 s-col12 col">
        <img
          ...
          alt="banner of the web"
          class="col12 s-col12 col"
        />
      ...
      <section class="container">
        ...
        <div class="container-about">
          ...
          <div class="About-Statistics">
            ...
            <h3>
              <span class="number-stat">71,500</span
              ><span class="grayish">+ users</span>
            </h3>

            <p class="text-stat">Website Total Clicks</p>
            <h3>
              <span class="number-stat">13,700,000</span
              ><span class="grayish">+ clicks</span>
            </h3>

            <p class="text-stat">Website Total On-time</p>
            <h3>
              <span class="number-stat">135,000</span
              ><span class="grayish">+ hours</span>
            </h3>

            <p class="text-stat">Total Jobs hired</p>
            <h3>
              <span class="number-stat">17,900</span
              ><span class="grayish">+ Jobs hired</span>
            </h3>
          </div>
        </div>
      </section>
        ...
        <div class="container-faqs">
          <ol>
            ...
            <li>
              ...
              <span class="answer"
                >You can subscribe to our newsletter or set up job alerts to
            ...
            <li>
              ...
              <span class="answer"
                >Yes, we provide resources and tips for improving your resume,
            ...
            <li>
              ...
              <span class="answer"
                >Yes, our website is completely free for job seekers to use. You
            ...
            <li>
              ...
              <span
                >Yes, you can upload your resume to your profile after creating
            ...
            <li>
              ...
              <span
                >Yes, as the business is growing and thriving everyday, we also
